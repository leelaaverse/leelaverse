...
export default function Login({ isOpen, setIsOpen, setIsSignupModalOpen }) {
                            ...
                            <form onSubmit={handleSubmit} className="space-y-6">
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        className="w-full px-6 py-4 border-2 border-gray-300 dark:border-gray-600 rounded-2xl focus:outline-none focus:ring-4 focus:ring-indigo-500/20 focus:border-indigo-500 transition-all duration-300 cabin-regular bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400"
                                ...
                                <div className="flex items-center justify-between">
                                    <label className="flex items-center">
                                        ...
                                        />
                                        <span className="cabin-regular ml-2 text-sm text-gray-600 dark:text-gray-400">Remember me</span>
                                    </label>

                                    <button
                                        type="button"
                                        className="cabin-regular text-sm text-indigo-600 dark:text-indigo-400 hover:text-indigo-500 transition-colors duration-300"
                                    >
                                        Forgot password?
                                    </button>
                                </div>
