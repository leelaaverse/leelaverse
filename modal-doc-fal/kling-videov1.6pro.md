...
- **Endpoint**: `https://fal.run/fal-ai/kling-video/v1.6/pro/text-to-video`
- **Model ID**: `fal-ai/kling-video/v1.6/pro/text-to-video`
...
- **`video`** (`File`, _required_):
  The generated video
  - Examples: {"url":"https://v2.fal.media/files/fb33a862b94d4d7195e610e4cbc5d392_output.mp4"}
...
- [Model Playground](https://fal.ai/models/fal-ai/kling-video/v1.6/pro/text-to-video)
- [API Documentation](https://fal.ai/models/fal-ai/kling-video/v1.6/pro/text-to-video/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/kling-video/v1.6/pro/text-to-video)
